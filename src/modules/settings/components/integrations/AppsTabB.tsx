// TODO(cleanup): exploration variant — A/B/C share ~95% of code. Consolidate into one parametrized component once direction is chosen.
...
type Category = "communication" | "crm" | "projectMgmt" | "knowledge" | "compliance" | "infrastructure";
  ...
  return (
    <div style={shell}>
        ...
        {item.accountEmail && (
          <div style={{ padding: "14px 20px", borderBottom: `1px solid ${ws.divider}`, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, minWidth: 0, flex: 1 }}>
              <div style={{ width: 24, height: 24, borderRadius: "50%", backgroundColor: ws.elevated, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 11, fontWeight: 600, color: ws.body, fontFamily: f, flexShrink: 0 }}>{item.accountEmail.charAt(0).toUpperCase()}</div>
      ...
      <div style={{ padding: "12px 20px 16px", flexShrink: 0, display: "flex", alignItems: "center", justifyContent: "center" }}>
        <button onClick={() => setFlow("confirmDisable")} style={{ background: ws.errorBg, border: `1px solid ${ws.errorBorder}`, borderRadius: 8, cursor: "pointer", fontSize: 12, fontWeight: 500, color: ws.errorFg, fontFamily: f, whiteSpace: "nowrap", padding: "6px 14px", display: "inline-flex", alignItems: "center", justifyContent: "center", transition: "background-color 0.15s" }}
          onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = ws.errorHoverBg; }}
          onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = ws.errorBg; }}
...
export default function AppsTabB() {
  ...
  const categoryOrder: Category[] = ["communication", "crm", "projectMgmt", "knowledge", "compliance", "infrastructure"];
